...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <a class="navbar-brand"  href="aplosxrhsths.php">Περιβάλλον Χρήστη | Αρχική</a>
</ul>
</nav>
...
<nav class="navbar navbar-expand-lg bg-secondary navbar-dark">
  ...
  <ul class="nav navbar-nav navbar-collapse collapse justify-content-center">
    <li class="nav-item">
      <a class="nav-link" href="aplosxrhsths.php">Αρχική</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="aplosxrhsths_error.php">Αιτήματα</a>
    </li>
	<li class="nav-item">
      <a class="nav-link" href="aplosxrhsths_error.php">Χρήστες</a>
    </li>
	<li class="nav-item">
      <a class="nav-link" href="aplosxrhsths_error.php">Ρόλοι</a>
    </li>
	<li class="nav-item active">
      <a class="nav-link" href="aplosxrhsths_prof.php">Προφίλ</a>
    </li>
  </ul>
</nav>
</header>
...
<div class="container">
    ...
    <div class="form-group mt-5">
			...
			<a href="aplosxrhsths.php" class="btn btn-secondary active" role="button" aria-pressed="true">Ακύρωση / ΠΙΣΩ</a>
        </div>
