...
if(isset($_POST["id_rolou"]) && !empty($_POST["id_rolou"])){
    
    require_once "syndesh.php";
    
  
    $sql = "DELETE FROM rolos WHERE id_rolou = ?";
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger">
                            <input type="hidden" name="id_rolou" value="<?php echo trim($_GET["id_rolou"]); ?>"/>
                            ...
                            <p>
                                ...
                                <a href="admin_oloi_roloi.php" class="btn btn-secondary">Όχι</a>
                            </p>
                        </div>
                    </form>
                </div>
