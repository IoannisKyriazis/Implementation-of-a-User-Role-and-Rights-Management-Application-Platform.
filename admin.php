...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <a class="navbar-brand"  href="admin.php">Περιβάλλον Διαχειριστή | Αρχική</a>
</ul>
</nav>
...
<div class="container bg-light">
    <div class="row card bg-light text-black align-items-center">
		<div class="card-body bg-success">Εισέλθατε επιτυχώς στο σύστημα ως διαχειριστής!</div>  
        <div class="card-body"><br><br><br><br><br><br><br><br><br><br><br><br><br>Καλώς ήλθατε στο σύστημα του διαχειριστή, <?php echo $row['onoma_xrhsth']?>! Περιηγηθείτε στο μενού.</div>
